		...
		<!-- Home -->
			<div class="wrapper wrapper-style1 wrapper-first">
				<article class="container" id="top">
					<div class="row">
						<div class="4u">
							<span class="me image image-full"><img src="https://lh4.googleusercontent.com/-86NBDJQCd3s/AAAAAAAAAAI/AAAAAAAAAAA/R6msCUKcpcM/s96-c/photo.jpg" alt="" /></span>

						</div>
						<div class="8u">
							<header>
								<h1>Hi. I'm <p><strong>E</strong>zequiel<strong><br/>A</strong>lberto<br/><strong>D</strong>eSimone.</p></h1>
			...
			<div class="wrapper wrapper-style2">
				<article id="work">
					<header>
						...
						<span>Ezequiel careers is a seasoned software developer who has created software for many well-known companies, including Google, Playdom, Orbitz, and EA. He has also worked as a freelance project leader and developer, specializing in website development. He excels in a wide range of modern technologies.</span>
					</header>
					<div class="container">
						<div class="row">							
							<div class="4u">
								<section class="box box-style1">
									...
									<p>Please click on <a target="blank" href="https://docs.google.com/file/d/0B_pWppuro1eyYUFzZHBfeGdfZ3c/edit?usp=sharing">CV</a> to see or download my CV.</p>
								</section>
							</div>							
						</div>
					</div>
						...
						<div class="row">
							<div class="4u">
								<article class="box box-style2">
									<a href="rabinkarp.php" class="image image-full"><img src="images/portfolio06.jpg" alt="" /></a>
									<h3><a href="rabinkarp.php">RABIN-KARP</a></h3>
									<p>Rabin–Karp algorithm - by Ezequiel De Simone</p>
								</article>
							</div>
							<!--div class="4u">
								<article class="box box-style2">
		...
		<!-- Contact -->
			<div class="wrapper wrapper-style4">
				<article id="contact">
					...
					<div>
						<a href="mailto:eadesimone@gmail.com" class="button">Send me an email</a>						
						<!--div class="row">
							<div class="12u">
								<form method="post" action="#">
									<div>
										...
										<div class="row">
											<div class="12u">
												<a href="mailto:eadesimone@gmail.com" class="button form-button-submit">Send Message</a>
						...
						<div class="row row-special">
							<div class="12u">
								<h3>Find me on ...</h3>
								<ul class="social">
									<li class="twitter"><a href="https://twitter.com/3p3ch3" class="icon icon-twitter"><span>Twitter</span></a></li>
									<li class="facebook"><a href="#" class="icon icon-facebook"><span>Facebook</span></a></li>
									<li class="linkedin"><a href="http://ar.linkedin.com/in/edesimone" class="icon icon-linkedin"><span>LinkedIn</span></a></li>
									<li class="tumblr"><a href="#" class="icon icon-tumblr"><span>Tumblr</span></a></li>
									<li class="googleplus"><a href="https://plus.google.com/u/0/116079241428891463846/posts" class="icon icon-google-plus"><span>Google+</span></a></li>
